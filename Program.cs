...
string mensagemDeBoasVindas = "Boas vindas ao SpotMusic";
...
{
    Console.Clear();
    Console.WriteLine("Media da banda");
    Console.WriteLine("Digite o noma da banda que você gostaria de saber a média: ");
    string nomeDaBanda = Console.ReadLine()!;
    if (bandasRegistradas.ContainsKey(nomeDaBanda))
    {
